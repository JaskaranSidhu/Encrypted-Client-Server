...
Server.java: This is the prof's code and remains unchanged other than adding the debug flag to check if the user would like print statements for all protocols. 

ServerThread.java: This is where all of the decryption happens, once the message is recieved and decrypted it then sends an acknowledgement message to the client side. This is also where part of the key configuration takes place. 
